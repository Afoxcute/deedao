...
const PoolForm = ({ setIsCreate }) => {
    ...
    const [stakingAPY, setAPY] = useState(50);
    const [isAdmin, setAdmin] = useState(false);
    const [withdrawFee, setWithdrawFee] = useState(10);
    const [referralFee, setReferralRewardFee] = useState(20);
    ...
    const onAddStakingPool = async () => {
        ...
        //     console.log("createPoolState", txHash);
        //     setDataUpdate(!dataUpdate)
        // } catch (e) {
        //     console.error(e);
        // }
        console.log("Stellar staking pool creation not implemented yet");
    }
    ...
    const onCreateStakingState = async () => {
        ...
        //     console.error(e);
        // }
        console.log("Stellar staking state creation not implemented yet");
    };
    ...
    const onUpdateAuthority = async () => {
        ...
        //     console.error(e);
        // }
        console.log("Stellar authority update not implemented yet");
    }
    ...
    const onUpdateStakingState = async () => {
        ...
        //     console.error(e);
        // }
        console.log("Stellar staking state update not implemented yet");
    }
    ...
    const onDepositStakingReward = async () => {
        ...
        //     console.error(e);
        // }
        console.log("Stellar staking reward deposit not implemented yet");
    };
    ...
    const onClaimToken = async () => {
        ...
        //     console.error(e);
        // }
        console.log("Stellar token claim not implemented yet");
    }
    ...
    const onAddVestingPool = async () => {
        ...
        //     console.error(e);
        // }
        console.log("Stellar vesting pool creation not implemented yet");
    }
    ...
    const onCreateVestingState = async () => {
        ...
        //     console.error(e);
        // }
        console.log("Stellar vesting state creation not implemented yet");
    };
    ...
    const onDepositVestingReward = async () => {
        ...
        //     console.error(e);
        // }
        console.log("Stellar vesting reward deposit not implemented yet");
    };
