...
const NFTVestingSection = () => {
  ...
  async function fetchAll() {
    ...
    // }
    console.log("Stellar NFT vesting fetch not implemented yet");
  }
  ...
  const fetchUnvestedInfo = async () => {
    ...
    // }
    console.log("Stellar NFT unvested info fetch not implemented yet");
  };
  ...
  const fetchVestedInfo = async () => {
    ...
    // setVestedNfts(nfts);
    // setVault_items(arr);
    console.log("Stellar NFT vested info fetch not implemented yet");
  };
