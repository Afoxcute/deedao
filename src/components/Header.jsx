import { ConnectWalletButton } from './WalletContextProvider';
  ...
  return (
    <div className="flex items-center justify-between text-white h-20 w-full px-5">
      <div className="flex items-center justify-between w-full ">
        ...
        <div className="flex flex-col md:flex-row m-1 md:m-0 sm:my-0">
          <div className="hidden md:block time-menu-root h-12 mx-0 md:mx-2">
            <div className="relative rounded-[8px] flex items-center justify-between p-1  text-white text-1xl w-182 h-full border-2 dark:border-[#9A6440] bg-transparent text-[#9A6440] bg-gradient-to-r dark:from-[#994D0E] dark:to-[#E2914F] from-[#D97A2B] to-[#E2914F]">
              <span className="text-center">Stellar Staking Platform</span>
            </div>
          </div>
          ...
          <div className="text-primary-dark-bg dark:text-white">
            <div className="dapp-menu-links my-5">
              <div className="flex flex-col gap-2 dapp-nav my-1 ">
                <div
                  className={`hover:bg-[#482f1e] active:bg-[#976237] focus:outline-none focus:ring focus:ring-violet-300 w-full rounded h-full pl-3 ${location.pathname == "/dashboard"
                ...
                <div
                  className={`hover:bg-[#482f1e] active:bg-[#976237] focus:outline-none focus:ring focus:ring-violet-300 w-full rounded h-full pl-3 ${location.pathname == "/vesting"
                    ? "bg-[#CD8143]/10 text-[#CD8143] hover:text-white"
                    : ""
                    }`}
                >
                ...
                <div
                  className={`hover:bg-[#482f1e] active:bg-[#976237] focus:outline-none focus:ring focus:ring-violet-300 w-full rounded h-full pl-3 ${location.pathname == "/staking"
                    ? "bg-[#CD8143]/10 text-[#CD8143] hover:text-white"
                    : ""
                    }`}
                >
                ...
                <div
                  className={`hover:bg-[#482f1e] active:bg-[#976237] focus:outline-none focus:ring focus:ring-violet-300 w-full rounded h-full pl-3 ${location.pathname == "/poolcreation"
                    ? "bg-[#CD8143]/10 text-[#CD8143] hover:text-white"
                    : ""
                    }`}
                >
